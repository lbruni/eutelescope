...
void jkConvert(const char* RunNum) {
...
vector<double> y_8;
  ...
  vector<double> resid_x0;
  vector<double> resid_x1;
  vector<double> resid_x2;
  vector<double> resid_x3;
  vector<double> resid_x4;
  vector<double> resid_x5;
  vector<double> resid_y0;
  vector<double> resid_y1;
  vector<double> resid_y2;
  vector<double> resid_y3;
